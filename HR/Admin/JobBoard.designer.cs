...
namespace Admin
{
    ...
    partial void OnlevelChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_level", DbType="VarChar (20) NOT NULL", CanBeNull=false)]
		public string level
		{
			get
			{
    ...
    partial void OnjobStateChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Job_Application", Storage="_Applications", ThisKey="id", OtherKey="job_id")]
    ...
    partial void Onstate_idChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Location_State", Storage="_States", ThisKey="state_id", OtherKey="id", IsUnique=true, IsForeignKey=false)]
		public State State
		{
			get
			{
    ...
    partial void OndateSubmittedChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Job_Application", Storage="_Job", ThisKey="job_id", OtherKey="id", IsForeignKey=true)]
		internal Job Job
		{
			get
			{
			...
			set
			{
							...
							|| (this._Job.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._job_id = default(Nullable<System.Guid>);
					}
					this.SendPropertyChanged("Job");
				}
			}
